import logo from '../assets/Remove-bg.ai_1720436642287.png';
const Footer = () => {
  return (
    <>
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <LinkGroup header="INFORMATION">
              ...
              <NavLink link="/#" label="Best Prices Guarantee" />
            </LinkGroup>
            <LinkGroup header="CUSTOMER SUPPORT">
              <NavLink link="/#" label="FAQ" />
              <NavLink link="/#" label="Payment options" />
